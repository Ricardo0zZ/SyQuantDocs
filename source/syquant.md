...
本人在学习量化框架时，发现很多项目代码虽为业界精品，但仍有部分书写不规范，且过于冗杂之处。 因此，从易于使用、方便传播、助力行业发展的角度出发，本项目将原项目代码化繁为简， 剔除数字货币所有内容，删减期货、期权的实盘相关，剔除繁杂且用处不大的数据工具与配置文件， 仅保留针对中国A股股票量化投资交易相关项目，专注于A股市场量化投资分析。 根据自己近些年在量化道路上所走过的坑，尽量为具有科研背景的个人爱好者、高校研究中心、中小型私募企业等提供一站式量化框架解决方案。
